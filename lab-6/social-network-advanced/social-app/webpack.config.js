...
module.exports = {
  mode: 'development',
  entry: './src/main.ts',
  output: { publicPath: 'http://localhost:9060/', uniqueName: 'socialApp' },
  ...
  plugins: [
    ...
    new ModuleFederationPlugin({
      name: 'socialApp',
      remotes: {
        postListApp: 'postListApp@http://localhost:9061/remoteEntry.js',
        profileApp: 'profileApp@http://localhost:9062/remoteEntry.js',
      },
      shared: {
