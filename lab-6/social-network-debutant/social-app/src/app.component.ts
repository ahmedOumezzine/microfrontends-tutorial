...
@Component({
  ...
  template: `
    <nav class="navbar navbar-dark bg-secondary"><div class="container"><span class="navbar-brand">Social App - Lab 6</span><span class="badge text-bg-light">{{ selectedAuthor() }}</span></div></nav>
