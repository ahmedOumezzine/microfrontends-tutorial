# Lab 6 - Tests (Debutant)

Ce projet est la version **Debutant** du Lab 6. Il implemente un reseau social avec Angular, Jest, Webpack 5 et Module Federation.
...
- Point fort de cette version : configuration simple pour comprendre les tests unitaires et les contrats.

## Applications

| Application | Role | Port |
| --- | --- | --- |
| `social-app` | application principale qui charge les remotes et suit les publications consultees | 9000 |
| `post-list-app` | remote qui expose la liste des publications | 9001 |
| `profile-app` | remote qui expose le profil de l auteur selectionne | 9002 |
