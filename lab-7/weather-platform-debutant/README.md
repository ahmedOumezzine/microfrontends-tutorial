# Lab 7 - Communication inter-modules (Debutant)

Ce projet est la version **Debutant** du Lab 7. Il implemente une application meteo avec React, Webpack 5, Module Federation et Bootstrap.
...
- Point fort de cette version : evenement navigateur simple entre une liste et un detail.

## Applications

| Application | Role | Port |
| --- | --- | --- |
| `weather-app` | application principale qui orchestre les evenements meteo | 9000 |
| `forecast-list-app` | remote qui expose la liste des villes | 9001 |
| `weather-detail-app` | remote qui affiche les details de la ville selectionnee | 9002 |
