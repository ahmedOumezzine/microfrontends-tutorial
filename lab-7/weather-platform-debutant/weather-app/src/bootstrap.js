...
function App() {
  ...
  return (
    <>
      <nav className="navbar navbar-dark bg-primary"><div className="container"><span className="navbar-brand">Weather App - Lab 7</span><span className="badge text-bg-light">{city}</span></div></nav>
