...
module.exports = {
  mode: 'development',
  entry: './src/main.js',
  output: { publicPath: 'http://localhost:9080/' },
  devServer: {
    port: 9080,
  ...
  plugins: [
    ...
    new ModuleFederationPlugin({
      name: 'galleryApp',
      remotes: {
        photoListApp: 'photoListApp@http://localhost:9081/remoteEntry.js',
        photoViewerApp: 'photoViewerApp@http://localhost:9082/remoteEntry.js',
      },
