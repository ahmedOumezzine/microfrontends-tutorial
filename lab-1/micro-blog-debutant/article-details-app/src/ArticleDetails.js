...
const mockDetails = {
  ...
  "2": {
    ...
    content: "Module Federation permet de creer des applications modulaires...",
    date: "2023-09-15",
  },
};
        ...
        {article ? (
          <>
            ...
            <p className="card-text">
              <small className="text-muted">Publie le {article.date}</small>
            </p>
          </>
        ) : (
          <p className="card-text">Selectionnez un article pour voir les details.</p>
        )}
      </div>
    </div>
  );
