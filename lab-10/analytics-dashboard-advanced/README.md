# Lab 10 - CI/CD (Advanced)

Ce projet est la version **Advanced** du Lab 10. Il implemente un tableau de bord analytique avec React, Chart.js, GitHub Actions, Webpack 5 et Module Federation.
...
- Point fort de cette version : workflow GitHub Actions mis a jour pour les deux versions, rapport qualite, graphique enrichi et ports dedies.

## Applications

| Application | Role | Port |
| --- | --- | --- |
| `analytics-app` | application principale qui orchestre les graphiques et les rapports | 9100 |
| `chart-list-app` | remote qui expose un graphique Chart.js et la selection de rapport | 9101 |
| `report-detail-app` | remote qui affiche le rapport selectionne | 9102 |
...
- Les ports utilises sont : `9100`, `9101`, `9102`.
...
- Le Host s ouvre sur `http://localhost:9100`.
- Les deux remotes repondent sur `http://localhost:9101` et `http://localhost:9102`.
