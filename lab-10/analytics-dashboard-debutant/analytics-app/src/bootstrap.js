...
function App() {
  ...
  return (
    <>
      <nav className="navbar navbar-dark bg-dark"><div className="container"><span className="navbar-brand">Analytics App - Lab 10</span><span className="badge text-bg-light">CI/CD</span></div></nav>
