# Lab 9 - Deploiement (Advanced)

Ce projet est la version **Advanced** du Lab 9. Il implemente une plateforme de reservation de services avec Angular, Vercel, Webpack 5 et Module Federation.
...
- Point fort de cette version : offre cloud supplementaire, reset apres reservation, fichiers Vercel en npm et ports dedies.

## Applications

| Application | Role | Port |
| --- | --- | --- |
| `booking-app` | application principale qui charge les offres et le formulaire de reservation | 9090 |
| `offer-list-app` | remote qui expose les offres de service | 9091 |
| `offer-detail-app` | remote qui gere le detail et la confirmation de reservation | 9092 |
...
- Les ports utilises sont : `9090`, `9091`, `9092`.
...
- Le Host s ouvre sur `http://localhost:9090`.
- Les deux remotes repondent sur `http://localhost:9091` et `http://localhost:9092`.
