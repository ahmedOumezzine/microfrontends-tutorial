...
module.exports = {
  mode: 'development',
  entry: './src/main.ts',
  output: { publicPath: 'http://localhost:9000/', uniqueName: 'bookingApp', clean: true, path: __dirname + '/dist' },
  ...
  plugins: [
    ...
    new ModuleFederationPlugin({
      name: 'bookingApp',
      remotes: {
        offerListApp: 'offerListApp@http://localhost:9001/remoteEntry.js',
        offerDetailApp: 'offerDetailApp@http://localhost:9002/remoteEntry.js',
      },
      shared: {
